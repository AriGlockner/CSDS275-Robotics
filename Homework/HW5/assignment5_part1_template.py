...
To use the functions you wrote in my_functions.py you write the following:
func.FUNCTION_NAME(arguments)

for this to work my_functions.py has to be in the same directory as this py file.
...
pixel_locations = my_functions.threshold(image)
